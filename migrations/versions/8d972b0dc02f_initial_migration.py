...
Revision ID: 8d972b0dc02f
Revises: 
Create Date: 2025-07-18 11:41:25.124087
...
def upgrade():
    ...
    sa.Column('current_job_title', sa.String(length=128), nullable=True),
    ...
    sa.Column('event_image', sa.String(length=256), nullable=True),
    ...
    sa.Column('application_url', sa.String(length=256), nullable=True),
